import { CLIConvertor } from "./CLIConverter";
...
let convertor: CLIConvertor = new CLIConvertor("./tests/test.json");
...
describe("Check appended data in the json output file", function() {
    ...
    it("multiple appends", function() {
        let convertorTestBlock2 = new CLIConvertor("./tests/testoutput.json");
        ...
        let jsonOutput: string = fs.readFileSync(convertorTestBlock2.targetJsonPath, "utf8");
...
describe("Application 3 iteration", function() {
    let convertorTestBlock3 = new CLIConvertor("./tests/testoutput2.json");
    ...
    it("check output file (ommiting duration)", function() {
        let jsonOutput: string = fs.readFileSync(convertorTestBlock3.targetJsonPath, "utf8");
        let jsonParsed = JSON.parse(jsonOutput);
